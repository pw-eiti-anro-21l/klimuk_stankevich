...
3. Parametry DH są przechowywane w pliku `params.yaml`
...
7. Wpisać polecenie `ros2 launch custom_urdf view_robot_launch.py `
8. Dla zakończenia pracy sytemu należy wcisnąć `CTRL+C` i zamknąć otwarte terminale
