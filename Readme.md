...
10. Zmieniając plik `params.yaml` i ponownie uruchamiając launch'e dostajemy wizualizację o aktualnych (zmienionych parametrach):![dh1](./DH1.png) ![rviz1](./RVIZ1.png) ![dh2](./DH2.png) ![rviz2](RVIZ2.png)
