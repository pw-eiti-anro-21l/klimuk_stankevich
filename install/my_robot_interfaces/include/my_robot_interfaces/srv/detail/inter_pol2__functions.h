...
#ifndef MY_ROBOT_INTERFACES__SRV__DETAIL__INTER_POL2__FUNCTIONS_H_
#define MY_ROBOT_INTERFACES__SRV__DETAIL__INTER_POL2__FUNCTIONS_H_
...
/// Initialize srv/InterPol2 message.
/**
...
/// Finalize srv/InterPol2 message.
/**
...
/// Create srv/InterPol2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_robot_interfaces__srv__InterPol2_Request__init().
...
/// Destroy srv/InterPol2 message.
/**
 * It calls
 * my_robot_interfaces__srv__InterPol2_Request__fini()
...
/// Initialize array of srv/InterPol2 messages.
/**
...
/// Finalize array of srv/InterPol2 messages.
/**
 * It calls
 * my_robot_interfaces__srv__InterPol2_Request__fini()
...
/// Create array of srv/InterPol2 messages.
/**
 * It allocates the memory for the array and calls
 * my_robot_interfaces__srv__InterPol2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InterPol2 messages.
/**
 * It calls
 * my_robot_interfaces__srv__InterPol2_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_robot_interfaces__srv__InterPol2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_interfaces
...
/**
 * It calls
 * my_robot_interfaces__srv__InterPol2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_robot_interfaces__srv__InterPol2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_interfaces
...
/**
 * It calls
 * my_robot_interfaces__srv__InterPol2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_ROBOT_INTERFACES__SRV__DETAIL__INTER_POL2__FUNCTIONS_H_
