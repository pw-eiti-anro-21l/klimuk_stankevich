...
def main(args=None):
    ...
    # shoulder_param = ('joint_shoulder', result_table[0])
    # elbow_param = ('joint_elbow', result_table[1])
    # wrist_param = ('joint_wrist', result_table[2])
    # fixed_end_param = ('joint_fixed_end', result_table[3])
